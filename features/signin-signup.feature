...
Feature: Sign up/Sign in
    ...
    Scenario: User writes an invalid Date of Birth when creating an account
        Given the User is on the home page
        And the User navigates to the Registration page
        When the User fills all required fields with valid data except the date of birth
        And the User clicks the register button
